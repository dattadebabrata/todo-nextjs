...
import {ComboboxItem, Group, MultiSelect, SelectProps} from "@mantine/core";
...
const formatter=(check)=>{
    console.log(check,'is anything')
    return 'sdf'
}
const MultiSelectDropdownComponent = (props: MultiSelectDropdownComponentProps) => {
    const {
    ...
    return (
        <MultiSelect
            className={'multi-select-dropdown-component'}
            label={label}
